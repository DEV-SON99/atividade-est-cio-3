...
# Imprimir o conteúdo da tupla
print("Conteúdo da primeira_tupla:", primeira_tupla)

# Encontrar e imprimir o índice do elemento 4 na tupla
indice_elemento_4 = primeira_tupla.index(4)
print("Índice do elemento 4:", indice_elemento_4)

# Verificar e imprimir se a tupla contém o elemento 3
contém_elemento_3 = 3 in primeira_tupla
print("A tupla contém o elemento 3:", contém_elemento_3)

# Verificar e imprimir se a tupla contém o elemento 33
